<?php
$domain_root = "http://protonsign.mandatoryfun.com/"; # root of these web/php urls
$data_dir = "/data/protonsign/"; # directory where overall app is
$login_link = "http://protonsign.mandatoryfun.com/"; # link for proton login
$sign_link = "http://protonsign.mandatoryfun.com/"; # link for signing
$email_from = "ProtonSign Apache <apache@mandatoryfun.com>"; # from email address
